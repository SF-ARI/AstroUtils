A collection of astronomy modules
---------------------------------
...
This project is Copyright (c) SF-ARI and licensed under
...
We love contributions! AstroUtils is open source,
...
AstroUtils based on its use in the README file for the
